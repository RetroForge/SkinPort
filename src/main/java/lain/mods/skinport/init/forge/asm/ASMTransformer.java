...
public class ASMTransformer implements IClassTransformer {
    ...
    class transformer001 extends ClassVisitor {
            ...
            public void visitInsn(int opcode) {
                if (opcode == Opcodes.ARETURN) {
                    ...
                    this.visitMethodInsn(
                        ...
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "getLocationCape",
                        "(Lnet/minecraft/client/entity/AbstractClientPlayer;Lnet/minecraft/util/ResourceLocation;)Lnet/minecraft/util/ResourceLocation;",
                        false);
                }
            ...
            public void visitInsn(int opcode) {
                if (opcode == Opcodes.IRETURN) {
                    ...
                    this.visitMethodInsn(
                        ...
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "hasCape",
                        "(Lnet/minecraft/client/entity/AbstractClientPlayer;Z)Z",
                        false);
                }
                super.visitInsn(opcode);
            }
        ...
        ObfHelper m001 = ObfHelper
            .newMethod(
                "func_110303_q",
                "net/minecraft/client/entity/AbstractClientPlayer",
                "()Lnet/minecraft/util/ResourceLocation;")
            .setDevName("getLocationCape");
        ObfHelper m002 = ObfHelper
            .newMethod(
                "func_110306_p",
                "net/minecraft/client/entity/AbstractClientPlayer",
                "()Lnet/minecraft/util/ResourceLocation;")
            .setDevName("getLocationSkin");
        ObfHelper m003 = ObfHelper
            .newMethod("func_152122_n", "net/minecraft/client/entity/AbstractClientPlayer", "()Z"); // hasCape
        ObfHelper m004 = ObfHelper
            .newMethod("func_152123_o", "net/minecraft/client/entity/AbstractClientPlayer", "()Z"); // hasSkin
    ...
    class transformer002 extends ClassVisitor {
        ...
        class method001 extends MethodVisitor {
            ...
            ObfHelper target = ObfHelper
                .newMethod(
                    "func_147499_a",
                    "net/minecraft/client/renderer/tileentity/TileEntitySpecialRenderer",
                    "(Lnet/minecraft/util/ResourceLocation;)V")
                .setDevName("bindTexture");
            ObfHelper humanoidHead = ObfHelper.newField(
                "field_147533_g",
                "net/minecraft/client/renderer/tileentity/TileEntitySkullRenderer",
                "Lnet/minecraft/client/model/ModelSkeletonHead;"); // humanoidHead
            ...
            public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
                if (opcode == Opcodes.INVOKEVIRTUAL && target.match(name, desc) && lastALOAD == 9) {
                    ...
                    this.visitMethodInsn(
                        Opcodes.INVOKESTATIC,
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "TileEntitySkullRenderer_bindTexture",
                        "(Lcom/mojang/authlib/GameProfile;Lnet/minecraft/util/ResourceLocation;)Lnet/minecraft/util/ResourceLocation;",
                        false);
                    ...
                    this.visitFieldInsn(
                        Opcodes.GETFIELD,
                        humanoidHead.getData(0),
                        "field_147533_g",
                        humanoidHead.getData(2)); // hacky solution
                    this.visitMethodInsn(
                        Opcodes.INVOKESTATIC,
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "TileEntitySkullRenderer_bindHumanoidHead",
                        "(Lnet/minecraft/util/ResourceLocation;Lnet/minecraft/client/model/ModelSkeletonHead;)Lnet/minecraft/client/model/ModelSkeletonHead;",
                        false);
        ...
        ObfHelper m001 = ObfHelper.newMethod(
            "func_152674_a",
            "net/minecraft/client/renderer/tileentity/TileEntitySkullRenderer",
            "(FFFIFILcom/mojang/authlib/GameProfile;)V"); // renderSkull
    ...
    class transformer003 extends ClassVisitor {
            ...
            public void visitInsn(int opcode) {
                if (opcode == Opcodes.ARETURN) {
                    ...
                    this.visitMethodInsn(
                        Opcodes.INVOKESTATIC,
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "RenderManager_getEntityRenderObject",
                        "(Lnet/minecraft/client/renderer/entity/RenderManager;Lnet/minecraft/entity/Entity;Lnet/minecraft/client/renderer/entity/Render;)Lnet/minecraft/client/renderer/entity/Render;",
                        false);
                }
                super.visitInsn(opcode);
            }
        ...
        ObfHelper m001 = ObfHelper
            .newMethod(
                ...
                "(Lnet/minecraft/entity/Entity;)Lnet/minecraft/client/renderer/entity/Render;")
            .setDevName("getEntityRenderObject");
            ...
            public void visitInsn(int opcode) {
                if (opcode == Opcodes.RETURN) {
                    ...
                    this.visitMethodInsn(
                        Opcodes.INVOKESTATIC,
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "GuiOptions_postInitGui",
                        "(Lnet/minecraft/client/gui/GuiOptions;Ljava/util/List;)V",
                        false);
                }
                super.visitInsn(opcode);
            }
        ...
        class method002 extends MethodVisitor {
            ...
            public void visitCode() {
                ...
                this.visitMethodInsn(
                    Opcodes.INVOKESTATIC,
                    "lain/mods/skinport/init/forge/asm/Hooks",
                    "GuiOptions_preActionPerformed",
                    "(Lnet/minecraft/client/gui/GuiOptions;Lnet/minecraft/client/gui/GuiButton;)V",
                    false);
            }

        }

        ObfHelper m001 = ObfHelper.newMethod("func_73866_w_", "net/minecraft/client/gui/GuiOptions", "()V")
            .setDevName("initGui");
        ObfHelper m002 = ObfHelper
            .newMethod(
                "func_146284_a",
            ...
            .setDevName("actionPerformed");

        ObfHelper f001 = ObfHelper.newField("field_146292_n", "net/minecraft/client/gui/GuiScreen", "Ljava/util/List;")
            .setDevName("buttonList");
            ...
            public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
                if (opcode == Opcodes.INVOKESPECIAL && "<init>".equals(name)) {
                    ...
                    this.visitMethodInsn(
                        Opcodes.INVOKESTATIC,
                        "lain/mods/skinport/init/forge/asm/Hooks",
                        "ModelBiped_initWidth",
                        "(Lnet/minecraft/client/model/ModelBiped;I)I",
                        false);
    ...
    public byte[] transform(String name, String transformedName, byte[] bytes) {
        if ("net.minecraft.client.entity.AbstractClientPlayer".equals(transformedName)) return transform001(bytes);
        if ("net.minecraft.client.renderer.tileentity.TileEntitySkullRenderer".equals(transformedName))
            return transform002(bytes);
        if ("net.minecraft.client.renderer.entity.RenderManager".equals(transformedName)) return transform003(bytes);
        if ("net.minecraft.client.gui.GuiOptions".equals(transformedName)) return transform004(bytes);
        if ("net.minecraft.client.model.ModelBiped".equals(transformedName)) return transform005(bytes);
        return bytes;
    }
