...
public class Hooks {
    ...
    public static Render RenderManager_getEntityRenderObject(RenderManager manager, Entity entity, Render result) {
        if (entity instanceof EntityPlayerSP || entity instanceof EntityClientPlayerMP
    ...
    public static ModelSkeletonHead TileEntitySkullRenderer_bindHumanoidHead(ResourceLocation location,
        ModelSkeletonHead result) {
